...
export const COMPLETION_STEPS = [
  ...
  /* Roadmap order mirrors the wizard's Step 13-16 reshuffle:
  ...
  { step: 13, label: 'License Gap',                check: (d: CheckData) => d.licenseGapCount > 0 },
  { step: 14, label: 'Urgent Actions',             check: (d: CheckData) => d.actionsCount > 0 },
  { step: 15, label: 'Recommended Enhancements',   check: (d: CheckData) => d.enhancementsCount > 0 },
