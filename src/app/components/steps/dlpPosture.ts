...
/* Curated defaults — baseline catalogue exported from a live engagement
   on 2026-05-23 (forcepoint-hc-destination-patterns v1 envelope). Covers
   the bulk of the 2025-26 GenAI / SaaS / Webmail landscape. Operators
   can edit/extend per session via the "GenAI Apps" catalogue page. */
